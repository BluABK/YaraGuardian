...
urlpatterns = [url(r'^$',
               ...
               url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
                   auth_views.PasswordResetConfirmView, {'template_name': 'prelogin/ResetPassword.html'},
                   name='password_reset_confirm'),

               url(r'^reset/done/$',
                   auth_views.PasswordResetCompleteView, {'template_name': 'prelogin/ResetPasswordSuccess.html'},
